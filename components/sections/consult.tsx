...
export default function ConsultSection() {
  return (
    <section
      id="konsultasi"
      className="px-6 sm:px-8 py-16 sm:py-20 scroll-mt-28"
    >
      <div className="shell grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-12 items-start">
        <div className="space-y-3 lg:col-span-2">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed">
            Isi formulir berikut dan tim sales kami akan menghubungi Anda
            untuk membantu memilih tipe BYD yang tepat, atau menjadwalkan
            test drive gratis langsung di showroom.
          </p>
        </div>
